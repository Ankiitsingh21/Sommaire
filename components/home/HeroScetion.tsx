...
export default function HeroScetion() {
  return (
    <section className="relative mx-auto flex flex-col z-0 items-center justify-center py-16 sm:py-20 lg:pv-28 transition-all  animate-in lg:px-12 max-w-7xl">
      ...
      <div>
        <Button
          ...
          className="text-white mt-6 text-base sm:text-lg lg:text-xl 
             ...
             font-bold hover:no-underline shadow-lg transition-all duration-300
