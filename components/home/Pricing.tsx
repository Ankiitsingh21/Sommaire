...
const PricingCard = ({
  ...
  return (
    <div className="relative w-full max-w-lg hover:scale-105 hover:transition-all duration-300">
      <div className={cn("relative flex flex-col h-full gap-4 lg:gap-8 z-10  p-8 border-[1px] boder-gray-500/20 rounded-2xl ",
        id==='pro' && 'border-rose-500 gap-5 border-2'
      )
      } >
        <div className="flex jusitfy-between items-center gap-4">
          <div>
        ...
        <div className="flex gap-2" >
          ...
          <div className="flex flex-col justify-end mg-[4px]" >
  ...
  return (
    ...
    >
      <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="justify-center flex items-center w-full pb-12" >
