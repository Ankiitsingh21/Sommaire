...
const steps: Steps[] = [
  {
    ...
    description: "Simply darg and drop your PDF documnet or click to upload ",
  },
  {
    icon: <BrainCircuit size={64} strokeWidth={1.5} />,
    label: "AI Analysis",
    description:
      "Our advanced AI processes and analysis your decument instantly ",
  },
  {
...
export default function HowITWorkSection() {
  return (
    <section className="relative overflow-hidden bg-gray-50  ">
      <div className="py-12 lg:py-24 maz-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div
          aria-hidden="true"
        ...
        <div className="text-center mb-16">
          ...
          <h3 className="font-bold text-3xl max-w-2xl mx-auto">
            Transform aqny PDF into an easy-to-digest summary in three simple
            steps
          </h3>
        </div>
